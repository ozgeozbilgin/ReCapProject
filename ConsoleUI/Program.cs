...
namespace ConsoleUI
{
    class Program
    {
        ...
        private protected static void AddCustomerTest()
        {
            ...
            CustomerManager customerManager = new CustomerManager(new EfCustomerDal());
            customerManager.Add(new Customer { UserId = userManager.GetById(1).Data.Id, CompanyName = "Deneme " });
        }

        private protected static void AddUserTest()
        {
            UserManager userManager = new UserManager(new EfUserDal());
            userManager.Add(new User { FirstName = "özge", LastName = "özbilgin", Email = "ozge@gmail.com" });
        }
        ...
        private protected static void UpdateColorTest()
        {
            ...
            colorManager.Update(new Color { ColorId = 1, ColorName = "Siyah" });
        }
